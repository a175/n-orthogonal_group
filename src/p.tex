...
\begin{align*}
  s(\alpha_{1,2})&=-\alpha_{1,2}\\
  s(\alpha_{3,1})&=\alpha_{3,2}
&s(\alpha_{3,2})&=\alpha_{3,1}\\
s(\gamma_1)&=\gamma_{2}&
s(\gamma_2)&=\gamma_{1}\\
s(-\gamma_3)&=-\gamma_{3}&
\\
  s'(\alpha_{1,2})&=-\alpha_{1,3}=\alpha_{3,1}
&s'(\alpha_{3,1})&=-\alpha_{2,1}=\alpha_{1,2}\\
s'(\alpha_{3,2})&=\alpha_{3,2}\\
s'(\gamma_1)&=-\gamma_{1}&
s'(\gamma_2)&=-\gamma_{3}&
s'(-\gamma_3)&=\gamma_{2}
\end{align*}
