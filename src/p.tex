...
\begin{align*}
  \varsigma_1=\alpha(\frac{\pi}{2}),
  \varsigma_2=\alpha(\frac{(m-1)\pi}{m}-\frac{\pi}{2})=\alpha(\frac{-\pi}{m}+\frac{\pi}{2}),
\end{align*}
とおくことにする.
$\Braket{\alpha_0, \varsigma_1} = 0$であるので, $\RR\alpha_0=H_{\varsigma_1}$である.
また, 
$\Braket{\alpha_{m-1}, \varsigma_2} = 0$であるので, $\RR\alpha_0=H_{\varsigma_2}$である.
さらに,
\begin{align*}
 \Lambda_1&= \Set{\lambda\in V|\Braket{\lambda,\varsigma_1}\geq 0}\\
 \Lambda_2&= \Set{\lambda\in V|\Braket{\lambda,\varsigma_2}\geq 0}\\
...
である.
\begin{align*}
\Braket{\alpha_i,\varsigma_1}=\Braket{\alpha(\frac{i\pi}{m}),\alpha(\frac{\pi}{2})}=\cos(\frac{i\pi}{m}-\frac{\pi}{2})=\sin(\frac{i\pi}{m})
\Braket{\alpha_i,\varsigma_2}=\Braket{\alpha(\frac{i\pi}{m}),\alpha(\frac{-\pi}{m}+\frac{\pi}{2})}
