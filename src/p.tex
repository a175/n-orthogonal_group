...
また,
\begin{align*}
P_i\alpha_k&=P_{\frac{2i\pi}{m}}\alpha_{\frac{k\pi}{m}}\\
&=
  \begin{pmatrix}
    \cos(\frac{2i\pi}{m}) & \sin(\frac{2i\pi}{m}) \\
    \sin(\frac{2i\pi}{m}) & -\cos(\frac{2i\pi}{m}) 
...
&=
  \begin{pmatrix}
    \cos(\frac{2i\pi}{m}) \sin(\frac{k\pi}{m})+ \sin(\frac{2i\pi}{m})\cos(\frac{k\pi}{m}) \\
    \sin(\frac{2i\pi}{m}) \sin(\frac{k\pi}{m})- \cos(\frac{2i\pi}{m})\cos(\frac{k\pi}{m}) 
  \end{pmatrix}\\  
&=
  \begin{pmatrix}
    \cos(\frac{2i\pi}{m}) \sin(\frac{k\pi}{m})+ \sin(\frac{2i\pi}{m})\cos(\frac{k\pi}{m}) \\
