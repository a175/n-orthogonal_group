...
\begin{remark}
  $w\in W$に対し,
  $w^{-1}(\Phi_\Delta^-)=\Set{w^{-1}(\beta)|\beta\in\Phi_\Delta^-}$とおく.
  このとき, 
  \begin{align*}
...
$\Phi^+=\Phi_\Delta^+$,
$W=W(\Phi)$, $S=\Set{s_\delta|\delta\in\Delta}$
とする.
...
\begin{definition}
  $w\in W$に対して,
  \begin{align*}
    \Phi^{+}(w)&=\Phi^+\cap w^{-1}(\Phi^{-})\\
    &=\Set{\alpha\in\Phi^+|w(\alpha)\in \Phi^-}\\
    n(w)&=\numof{\Phi^{+}(w)}
  \end{align*}
  とおく.
\end{definition}
...
\begin{proof}
  \begin{align*}
    \Phi^+\cap w(\Phi^{-})=w(w^{-1}(\Phi^+)\cap \Phi^{-})
  \end{align*}
  である. また, $w$は全単射であるので,
  \begin{align*}
    \numof{w(w^{-1}(\Phi^+)\cap \Phi^{-})}
    &=\numof{w^{-1}(\Phi^+)\cap \Phi^{-}}.
  \end{align*}
  また, $-1$倍する操作も全単射であるから,
  \begin{align*}
    \numof{w^{-1}(\Phi^+)\cap \Phi^{-}}
...
\begin{lemma}
  ...
  \item
    ...
    $w(\delta)\in\Phi^+ \implies n(ws_\delta)=n(w)+1$.
  \item
    \label{item:buruhat:formula:-1}
     $w(\delta)\in\Phi^- \implies n(ws_\delta)=n(w)-1$.
  \item
    \label{item:buruhat:formula:r:1}
    $w^{-1}(\delta)\in\Phi^+ \implies n(s_\delta w)=n(w)+1$.
  \item
    \label{item:buruhat:formula:r:-1}
    $w^{-1}(\delta)\in\Phi^- \implies n(s_\delta w)=n(w)-1$.
  \end{enumerate}
...
\begin{proof}
  \begin{align*}
    \Phi^{+}(ws_\delta)
    &=\Phi^+\cap(ws_\delta)^{-1}(\Phi^-)\\
    &=\Phi^+\cap(s_\delta)^{-1} w^{-1}(\Phi^-)\\
    &=\Phi^+\cap s_\delta w^{-1}(\Phi^-).
  \end{align*}
  ここで$\delta\in\Delta$に対し,
  \begin{align*}
    \Phi^+&=s_\delta(\Phi^+\setminus \Set{\delta}) \cup\Set{\delta}\\
    s_\delta(\Phi^+\setminus \Set{\delta})\cap \Set{\delta}&=\emptyset
  \end{align*}
  であるので, $\Phi^+\cap s_\delta w^{-1}(\Phi^-)$を調べるには,
  \begin{align*}
    s_\delta(\Phi^+\setminus \Set{\delta}) \cap s_\delta w^{-1}(\Phi^-)\\
    \Set{\delta} \cap s_\delta w^{-1}(\Phi^-)
  \end{align*}
  をそれぞれ調べればよい.

  \Cref{item:buruhat:formula:1}について考える.
  $w(\delta)=\alpha$とおく.
  仮定から$w(\delta)\in\Phi^+$であるので,
  $\alpha\in\Phi^+$であり,
  $-\alpha\in\Phi^-$である.
  ...
  \end{align*}
  となる. したがって,
  $\delta\in s_\delta(w^{-1}(\Phi^-))$である.
  したがって,
  \begin{align*}
    \Set{\delta} \cap s_\delta w^{-1}(\Phi^-) = \Set{\delta}
  \end{align*}
  である.
  ...
  一方
  \begin{align*}
    s_\delta(\Phi^+\setminus \Set{\delta})=s_\delta(\Phi^+)\setminus\Set{-\delta}
  \end{align*}
  である.
  $\delta=s_\delta(w^{-1}(-\alpha))$であるので,
  $-\delta=s_\delta(w^{-1}(\alpha))$となり,  
  $-\delta\in s_\delta(w^{-1}(\Phi^+))$であるから,
  $-\delta\not\in s_\delta(w^{-1}(\Phi^-))$である.
  したがって,
  \begin{align*}
    s_\delta(\Phi^+\setminus \Set{\delta}) \cap s_\delta w^{-1}(\Phi^-)
    &=
    s_\delta(\Phi^+) \cap s_\delta w^{-1}(\Phi^-)\\
    &=s_\delta(\Phi^+ \cap w^{-1}(\Phi^-))\\
    &=s_\delta(\Phi^+(w))
  \end{align*}
  である. 
  $\delta\not\in s_\delta(\Phi^+\setminus \Set{\delta})$
  であるので, $\delta\not\in s_\delta(\Phi^+(w))$
  である.
  ...
  $\delta\in s_\delta(w^{-1}(\Phi^+))$である.
  したがって,
  $\delta\not\in s_\delta(w^{-1}(\Phi^-))$であるので,
  \begin{align*}
    \Set{\delta} \cap s_\delta w^{-1}(\Phi^-) = \emptyset
  \end{align*}
  である.
  ...
  \end{align*}
  である.
  $\delta\in s_\delta(w^{-1}(\Phi^+))$であるので,
  $-\delta\in s_\delta(w^{-1}(\Phi^-))$である.
  したがって,
  \begin{align*}
    s_\delta(\Phi^+\setminus \Set{\delta}) \cap s_\delta w^{-1}(\Phi^-)
    &=
    (s_\delta(\Phi^+) \cap s_\delta w^{-1}(\Phi^-))\setminus\Set{-\delta}\\
    &=s_\delta(\Phi^+ \cap w^{-1}(\Phi^-))\setminus\Set{-\delta}\\
    &=s_\delta(\Phi^+(w))\setminus\Set{-\delta}
  \end{align*}
  である. 
...
\begin{definition}
  $w\in W$に対し,
  \begin{align*}
    \ell(w)=\min\Set{l|\delta_1,\ldots,\delta_l\in \Delta, w=s_{\delta_1}\cdots s_{\delta_l}}.
  \end{align*}
  とおき, $w$の長さと呼ぶ.
  ただし, $\ell(\id)=0$とする.
\end{definition}
\begin{definition}
  $w\in W$に対し,
  \begin{align*}
    w=s_{\delta_1}\cdots s_{\delta_{\ell(w)}}, (\delta_i\in \Delta)
  \end{align*}
  となる積の形を簡約表示と呼ぶ.  
\end{definition}
\begin{prop}
  ...
  \item
    ...
    $\ell(w)-1 \iff \exists \delta\in\Delta$ such that $w=s_\delta$.
  \item
...
\begin{proof}
  ...
  \begin{align*}
    ...
    &=s_l\cdots s_1
  \end{align*}
  である. したがって, $\ell(w) \geq \ell(w^{-1})$.
  また,
  $w^{-1}$からはじめて,
  同様に$\ell(w) \leq \ell(w^{-1})$.

  \Cref{item:len:det}について考える.
  $\delta\in\Delta$に対し, $\det(s_\delta)=-1$である.
  \begin{align*}
    \det(w)&=\det(s_1\cdots s_{\ell(w)})\\
    &=\det(s_1)\cdots \det(s_{\ell(w)})\\
    &=(-1)^{\ell(w)}.
  \end{align*}
\end{proof}

\begin{remark}
  \Cref{item:len:det}があるので,
...
\section{Deltetion and Exchange property}
...
したがって, \cref{lem:n:bruhat}は$\ell(w)$に読み替えられる.
\begin{theorem}
  \label{thm:l:bruhat}
  $\delta\in\Delta$, $w\in W$とする.
  このとき次が成り立つ:
  \begin{enumerate}
  \item
    $w(\delta)\in\Phi^+ \implies \ell(ws_\delta)=\ell(w)+1$.
  \item $w(\delta)\in\Phi^- \implies \ell(ws_\delta)=\ell(w)-1$.
  \item
    $w^{-1}(\delta)\in\Phi^+ \implies \ell(s_\delta w)=\ell(w)+1$.
  \item
    $w^{-1}(\delta)\in\Phi^- \implies \ell(s_\delta w)=\ell(w)-1$.
  \end{enumerate}
\end{theorem}
...
\begin{prop}
  ...
  $r=\ell(w)$とする.
  $\alpha\in \Delta$が$\ell(ws_\alpha)\leq \ell(w)$をみたすとき,
  \begin{align*}
