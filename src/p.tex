...
$m=1$のときは$P_0P_{m-1}=R_{0}=\id$である.
$m\geq 2$ならば, $P_0P_{m-1}=R_{1-m}\neq \id$であるので,
$\len_\Delta(P_0P_{m-1})=2$である.
$\ell_\Delta(P_{m-1}P_0)$も同様に,
$m=1$のときは$P_{m-1}P_0=\id$,
$m\geq 2$ならば, $\len_\Delta(P_{m-1}P_0)=\len_\Delta(R_{m-1})=2$である.
$\len_\Delta(P_{m-1}P_0)=2$である.
したがって, $m\geq 2$のときに, $\Set{P_0R_{m-1},P_{m-1}P_0}\subset W_2$であることがわかった.
...
$P_0P_{m-1}P_0=R_{1-m}P_0=P_{m-1}$である.
$m=2$であれば, $P_0P_{m-1}P_0=P_{1}\in W_1$であり,
$m>2$であれば, $P_0P_{m-1}P_0\in W_3$である.
$\ell_\Delta(P_{m-1}P_0P_{m-1})$も同様に,
$P_{m-1}P_0P_{m-1}=R_{m-1}P_{m-1}=P_{m-2}$であるので,
$m=2$であれば, $P_{m-1}P_0P_{m-1}=P_{0}\in W_1$であり,
$m>2$であれば, $P_{m-1}P_0P_{m-1}\in W_3$である.
 $m\geq 3$のときに, $\Set{P_0R_{m-1}P_0,P_{m-1}P_0P_{m-1}}= W_2$であることがわかる.
また, $m=2$のときには$P_0P_{m-1}=R_{1-m}=R_{1-m+m}=R_{1}$,
